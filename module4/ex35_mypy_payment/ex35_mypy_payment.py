...
class AbstractPayment(ABC):
    ...
    @abstractmethod
    def charge_payment(self, user_id: int, amount: int, currency: str, merchant_id: int) -> int:
        pass

    @abstractmethod
    def reverse_payment(self, user_id: int, amount: int, currency: str, merchant_id: int) -> int:
        pass
